...
namespace FluentSignals.Options.HttpResource
{
    ...
    public abstract class TypedHttpResource : ITypedHttpResource
    {
        ...
        /// </summary>
        public void Initialize(HttpClient httpClient, string baseUrl, HttpResourceOptions options)
        {
            _httpClient = httpClient ?? throw new ArgumentNullException(nameof(httpClient));
            BaseUrl = baseUrl ?? throw new ArgumentNullException(nameof(baseUrl));
            _options = options ?? throw new ArgumentNullException(nameof(options));
    ...
    public class HttpResourceRequest
    {
        ...
        protected readonly HttpResourceOptions _options;
        ...
        protected Action<HttpResource>? _configureResource;
        protected Action<HttpRequestMessage>? _configureRequest;
